...
var ResizeObserver = typeof window !== "undefined" && window.ResizeObserver || class {
...
var getTextNodeFromPoint = (element, x, y) => {
...
var calculateAspectRatioFit = (srcWidth, srcHeight, maxWidth, maxHeight) => {
...
var Panzoom = class extends Base {
...
Sync.defaults = defaults3;

// node_modules/@fancyapps/ui/src/Carousel/plugins/index.js
var Plugins2 = { Navigation, Dots, Sync };
...
var Carousel = class extends Base {
  constructor($container, options = {}) {
    options = extend(true, {}, defaults4, options);
    super(options);
    this.state = "init";
    this.$container = $container;
  ...
  processType(slide) {
    ...
    if (type === "html5video" || type === "video") {
      ...
      if (slide._width && slide._height) {
        ...
        slide.ratio = slide.ratio || slide.video.ratio || defaults6.video.ratio;
      }
    }
  }
  onReady() {
...
var Fancybox = class extends Base {
  constructor(items, options = {}) {
    ...
    super(extend(true, {}, defaults9, options));
    this.bindHandlers();
    this.state = "init";
    this.setItems(items);
...
Fancybox.defaults = defaults9;
Fancybox.openers = /* @__PURE__ */ new Map();
Fancybox.Plugins = Plugins3;
