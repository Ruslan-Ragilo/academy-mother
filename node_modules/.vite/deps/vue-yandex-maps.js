...
var require_vue_yandex_maps_esm = __commonJS({
  "node_modules/vue-yandex-maps/dist/vue-yandex-maps.esm.js"(exports) {
    Object.defineProperty(exports, "__esModule", { value: true });
    var e = require_vue();
    var t = Symbol();
    var o = new class {
    ...
    function n(e2) {
      return new Promise((t2, n2) => {
        ...
        a2.setAttribute("src", i2), a2.setAttribute("async", ""), a2.setAttribute("defer", ""), a2.setAttribute("id", "vue-yandex-maps-script"), document.head.appendChild(a2), o.scriptIsNotAttached = false, a2.onload = ((e3) => () => {
          ymaps.ready(() => {
    ...
    var c = e.defineComponent({ name: "YandexMap", props: { coordinates: { type: Array, required: true }, zoom: { type: Number, default: 10 }, bounds: { type: Array, default: null }, behaviors: { type: Array, default: null }, controls: { type: Array, default: null }, detailedControls: { type: Object, default: null }, events: { type: Array, default: () => ["click"], validator: (e2) => e2.every((e3) => s.includes(e3)) }, mapType: { type: String, default: "map" }, settings: { type: Object, default: () => ({}) }, panOptions: { type: Object, default: void 0 } }, emits: [...s, "geo-objects-updated", "created"], setup(a2, { emit: s2, slots: r2, expose: c2 }) {
      ...
      const u2 = `yandexMap${Math.round(1e5 * Math.random())}`, { addGeoObject: m2, deleteGeoObject: b2 } = d((e2, t2) => {
        i2 && e2.length && (e2.forEach((e3) => i2 == null ? void 0 : i2.geoObjects[t2](e3)), s2("geo-objects-updated", i2.geoObjects), e2 = []);
      });
      e.provide(t, { addGeoObject: m2, deleteGeoObject: b2 });
      const y2 = () => {
        if (l2.value = true, i2 = new ymaps.Map(u2, { center: a2.coordinates, zoom: a2.zoom, bounds: a2.bounds, behaviors: a2.behaviors, controls: a2.controls, type: `yandex#${a2.mapType}` }), a2.events.forEach((e2) => {
          var _a;
    ...
    var l = e.defineComponent({ name: "YandexMarker", props: { coordinates: { type: Array, required: true }, markerId: { type: [String, Number], required: true }, properties: { type: Object, default: () => ({}) }, options: { type: Object, default: null }, type: { type: String, default: "Point" }, radius: { type: Number, default: null }, events: { type: Array, default: () => ["click"], validator: (e2) => e2.every((e3) => r.includes(e3)) } }, emits: [...r], setup(o2, { emit: n2, slots: s2, expose: r2 }) {
      var _a, _b;
    ...
    var p = e.defineComponent({ name: "YandexGeoObjectCollection", props: { options: { type: Object, default: () => ({}) } }, emits: ["geo-objects-updated"], setup(o2, { emit: n2, expose: a2, slots: s2 }) {
      const r2 = new ymaps.GeoObjectCollection({}, o2.options), { addGeoObject: c2, deleteGeoObject: l2 } = e.inject(t) || {}, { addGeoObject: p2, deleteGeoObject: i2 } = d((e2, t2) => {
        r2 && e2.length && (e2.forEach((e3) => r2[t2](e3)), n2("geo-objects-updated", r2), e2 = []);
      });
    ...
    var i = e.defineComponent({ name: "YandexClusterer", props: { options: { type: Object, default: () => ({}) } }, emits: ["geo-objects-updated"], setup(o2, { emit: n2, expose: a2, slots: s2 }) {
      const r2 = new ymaps.Clusterer(o2.options), { addGeoObject: c2, deleteGeoObject: l2 } = e.inject(t) || {}, { addGeoObject: p2, deleteGeoObject: i2 } = d((e2, t2) => {
        r2 && e2.length && (r2[t2](e2), n2("geo-objects-updated", r2), e2 = []);
      });
      return e.provide(t, { addGeoObject: p2, deleteGeoObject: i2 }), e.onMounted(() => {
        c2(r2);
      }), e.onBeforeUnmount(() => {
    ...
    var u = e.defineComponent({ name: "YandexObjectManager", props: { options: { type: Object, default: () => ({}) } }, emits: ["geo-objects-updated"], setup(o2, { emit: n2, expose: a2, slots: s2 }) {
      const r2 = new ymaps.ObjectManager(o2.options), { addGeoObject: c2, deleteGeoObject: l2 } = e.inject(t) || {}, { addGeoObject: p2, deleteGeoObject: i2 } = d((e2, t2) => {
        ...
        r2[t2](o3), n2("geo-objects-updated", r2), e2 = [];
      }, true);
      return e.provide(t, { addGeoObject: p2, deleteGeoObject: i2 }), e.onMounted(() => {
        c2(r2);
      }), e.onBeforeUnmount(() => {
    ...
    exports.YandexClusterer = j, exports.YandexCollection = g, exports.YandexMap = y, exports.YandexMarker = h, exports.YandexObjectManager = v, exports.default = f, exports.loadYmap = b;
  }
});
export default require_vue_yandex_maps_esm();
