          ...
          <div class="school-tariff__with-support-block">
            <div class="school-tariff__price-label">
              ...
              <div class="school-tariff__tooltip">
                <b>
                  Те, кто вступит в Школу беременности на пакеты с обратной связью, получат дополнительные привелегии
                </b><br><br>
                — Общение и поддержку от других будущих мам в закрытом чате<br><br>
                — Обратную связь от главного эксперта Академии Элисо Джобавы. Каждый день (кроме субботы, воскресенья
